...
public class Application {
	...
	public void init() {
		...
		logicPhysicsIndexes.put(0,"master_00");
		logicPhysicsIndexes.put(1,"master_01");
		logicPhysicsIndexes.put(2,"master_02");
		logicPhysicsIndexes.put(3,"master_03");
